...
const ChangePassword: IPage = function ChangePassword({ user }) {
        ...
        <div className="py-10 px-5 xs:px-10">
            ...
            <Formik
                ...
                onSubmit={async (values, helpers) => {
                    ...
                    return onSubmit(values, helpers, email, () => {
                        setSuccess(true)
                    })
                }}
            >
                            ...
                            <div className="grid-cols-4 items-center space-y-2 xs:grid xs:gap-x-2 xs:text-right">
                                ...
                                <div className="xs:col-span-3">
                                    <Field
                                        ...
                                        aria-label={errors.confirm || undefined}
                                    />
                                    <ErrorMessage
                                        name="confirm"
                                        className="text-left text-xs capitalize text-red-500"
                                    ...
                                    <div className="inline-flex flex-col items-center">
                                        ...
                                        {isGoogleSignin ? (
                                            <div className="mt-2 text-xs text-gray-600">
                                                You are signIn with Google.if
                                                you want to change password.You
                                                have to change your Google id
                                                password.
                                            </div>
                                        ) : null}
