...
function BigScreenPost({
    ...
    return (
        <div className="mx-auto mt-10 max-w-4xl px-4">
            <div className="rounded-md border dark:border-zinc-700 sm:h-screen sm:max-h-[min(580px,100vh-2rem)]">
                <div className="grid h-full w-full overflow-auto sm:grid-cols-2">
                    <div className="relative aspect-square border-r bg-black dark:border-r-zinc-700 sm:aspect-auto">
                        <Image
                            src={photo}
                            alt={caption}
                            fill
                    ...
                    <section className="flex flex-col divide-y divide-secondary-lighter text-sm dark:divide-zinc-700">
                                    ...
                                    <UnStyledFollowButton userId={authorId}>
                                        {(isFollowing, props) => (
                                            <button
                                                className={clsx(
                                                    isFollowing
                                                        ? 'text-gray-950 hover:text-gray-500 dark:text-zinc-300'
                                ...
                                {isLoading ? (
                                    ...
                                    <>
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-secondary-light dark:text-zinc-400">
